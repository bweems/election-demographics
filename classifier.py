...
for feature in features:
    if feature[:8] == "HC02_EST":
        try:
            ...
            trainingError = 0
            for i in range(10):
                new_training_error, new_testing_error = test_features('environment', [feature])
                testingError += new_testing_error
                trainingError += new_training_error
            print "TestingError: " + str(testingError/10)
            print "TrainingError: " + str(trainingError/10)
